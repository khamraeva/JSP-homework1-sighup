...
class SignUp extends Component {
    ...
    validateControl(value, validation) {
        ...
        //     const confirmPassword = this.state.formControls.confirmPassword.value;
    ...
    checkPasswords = () => {
        console.log('1 ',this.state.formControls.password.value);
        console.log('2 ',this.state.formControls.confirmPassword.value);
    }
            ...
            <div className={'signup-container'}>
                ...
                <form
                    ...
                    <div className='btn-wrapper'>
                        <button onClick={this.checkPasswords}>Submit</button>
                    </div>
                </form>
            </div>
        )
