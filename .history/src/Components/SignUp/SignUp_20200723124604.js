...
class SignUp extends Component {
    state = {
        formControls: {
                firstName: {
                    ...
                    label: 'First name',
                    type:'text',
                    errorMessage: 'Please enter your name using only letters',
                    valid: false,
                    touched: false,
                    validation: {
                        required: true,
                ...
                lastName: {
                    ...
                    label: 'Last name',
                    type:'text',
                    errorMessage: 'Please enter your last name using only letters',
                    valid: false,
                    touched: false,
                    validation: {
                        required: true,
    ...
    validateControl(value, validation) {
        ...
        if (validation.isText) {
            isValid = /([A-Za-z])([\wа-я])/.test(value) && isValid; 
        }
        ...
        if (validation.check) {
            isValid = this.state.formControls.password.value === this.state.formControls.confirmPassword.value && isValid;
        }
